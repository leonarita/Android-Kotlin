...
import com.example.app5.constants.DataBaseConstants
import com.example.app5.entities.TaskEntity
import com.example.app5.repository.helper.TaskDataBaseHelper
...
class TaskRepository private constructor(context: Context) {
    ...
    fun get(taskID: Int): TaskEntity? {
        ...
        try {
            ...
            if (cursor.count > 0) {
                ...
                val description = cursor.getString(cursor.getColumnIndexOrThrow(DataBaseConstants.TASK.COLUMNS.DESCRIPTION))
    ...
    fun getList(filter: Int, userId: Int): MutableList<TaskEntity> {
        ...
        try {
            ...
            cursor = db.rawQuery("select * from ${DataBaseConstants.TASK.TABLE_NAME} WHERE " +
